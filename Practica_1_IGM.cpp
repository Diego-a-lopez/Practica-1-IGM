...
//
// Edited By alumni Diego Antonio López López with login diego.a.lopez and Alejandro Rodríguez Vaquero a.vaquero@udc.es
//
...
int main() {
  ...
  // Unbind vbo (they were conveniently registered by VertexAttribPointer)
...
void render(double currentTime) {
  ...
  //glDrawArrays(GL_QUADS, 0, 4); // Changed to draw a single face
}
